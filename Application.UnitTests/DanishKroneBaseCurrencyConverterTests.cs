...
namespace Application.UnitTests
{
    public class DanishKroneBaseCurrencyConverterTests
    {
        ...
        public void Convert_WhenAnyConfiguredCurrencyToDKK_ReturnsExpectedAmount(string mainCurrency)
        {
            ...
            var expectedExchangeAmount = mainAmount * _rates100UnitsMainToDKK[mainCurrency] / 100;
        ...
        [Fact]
        public void Convert_WhenDKKToAnyConfiguredCurrency_ReturnsExpectedAmount()
        {
